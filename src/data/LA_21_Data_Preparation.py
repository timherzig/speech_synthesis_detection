...
if __name__ == "__main__":
    ...
    # directory info of ASVspoof2021 dataset
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "--root_path", type=str, required=True, help="root path of ASVspoof2021 dataset"
    )
    args = parser.parse_args()

    root_path = args.root_path
    eval_protocol_path = root_path + "keys/LA/CM/trial_metadata.txt"
    eval_data_path = root_path + "ASVspoof2021_LA_eval/flac/"
