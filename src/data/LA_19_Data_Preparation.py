...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--root_path", type=str, required=True, help="root path of ASVspoof2019 dataset"
    )
    args = parser.parse_args()

    root_path = args.root_path
    train_protocol_path = (
        root_path + "ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.train.trn.txt"
    )
    dev_protocol_path = (
        root_path + "ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.dev.trl.txt"
    )
    eval_protocol_path = (
    ...
    gen_cqt_19(
        dev_protocol_path, dev_data_path, new_data_path, duration=cqt_dur, status="dev"
    )
    gen_cqt_19(
        eval_protocol_path,
        eval_data_path,
