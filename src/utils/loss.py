# Taken from "MULTITASK LEARNING IMPROVES SYNTHETIC SPEECH DETECTION" github.com/yzyouzhang/AIR-ASVspoof 12.2023:
#
#   https://github.com/yzyouzhang/AIR-ASVspoof/blob/master/loss.py
